    ...
    _bloc.add(
      PoliticiansLoadRequested(
        PoliticiansQuery(
          ...
          q: _searchQuery, // ✅ правильный параметр поиска
        ),
      ),
    );
  }
          ...
          children: [
            ...
            FiltersBar(
              ...
              onSearchChanged: (query) {
                ...
                _bloc.add(
                  PoliticiansLoadRequested(
                    PoliticiansQuery(limit: 20, level: _selectedLevel, q: query),
                  ),
                );
              },
              onClearSearch: () {
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (ctx, i) {
                      ...
                      return GestureDetector(
                        onTap: () =>
                            context.push('/app/politicians/${p.bioguideId}'),
